        ...
        <section className="portfolio block-wrapper">
            ...
            <ul className="portfolio__list">
                <li className="portfolio__list-item">
                    ...
                    <a className="portfolio__link" href="https://github.com/Hisime/how-to-learn" target="_blank">
                ...
                <li className="portfolio__list-item">
                    ...
                    <a className="portfolio__link" href="https://github.com/Hisime/russian-travel" target="_blank">
                        <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.60653 16.5241L14.9645 4.14489L14.9432 13.6903H17.2656V0.181818H3.77841L3.7571 2.48295H13.3026L0.944603 14.8622L2.60653 16.5241Z" fill="black"/>
                        </svg>
                    </a>
                ...
                <li className="portfolio__list-item">
                    ...
                    <a className="portfolio__link" href="https://hisime.github.io/mesto/" target="_blank">
                        <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.60653 16.5241L14.9645 4.14489L14.9432 13.6903H17.2656V0.181818H3.77841L3.7571 2.48295H13.3026L0.944603 14.8622L2.60653 16.5241Z" fill="black"/>
                        </svg>
                    </a>
